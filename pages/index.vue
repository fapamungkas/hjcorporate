        ...
        <div class="w-full md:w-1/2 md:mb-8 mb-12 md:pb-10">
          <h1
            class="
              ...
              md:text-5xl
              font-medium
              md:leading-tight md:pb-2
            "
          >
            Membantu mengubah produk menjadi luar biasa.
          </h1>
          <p class="pt-5 md:pr-16 md:leading-7 pb-8 md:pt-3 text-gray-600">
            Kami adalah perusahaan yang berfokus pada bidang teknologi, desain,
            konsultan, dan peternakan. Kami selalu memperhatikan setiap detail
            kecil dari produk yang kami kerjakan.
          </p>
      ...
      <div class="pt-16">
        ...
        <div class="pt-10">
          ...
          >
            ...
            >
              ...
              <p class="text-base text-[#404852] font-regular p-6">
                Projek yang diberikan partner akan dapat diselesaikan tepat
                waktu sesuai waktu yang diinginkan partner
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="pb-10 relative">
          ...
          <div class="relative">
            ...
            <Glass />
            <img
              class="image-about pb-6"
              src="../static/images/maskImage.svg"
              alt=""
            />
          </div>
          <SecondGlass />
