<template>
  <div class="contactPage">
    <div class="md:px-32 px-6 w-full flex md:flex-row flex-col justify-between relative">
      <div class="mt-5 absolute h-[50px] w-[50px] rounded-[50%] bg-[#A3A07C] z-10 right-[35px] top-0">
        <a href="/">
      ...
      <div class="md:pt-20 pt-10 pr-12 md:w-[45%] w-full">
        ...
        <div class="flex md:pt-24 pt-20">
          <button
            class="
              ...
              px-6
              rounded
              hover:border hover:border-[#06D6C6] hover:bg-[#05BDAF] hover:bg-opacity-10
              font-medium
              text-white
              items-center
            "
        ...
        <div class="flex pt-10">
          ...
          >
            ...
            Sinduharjo, Kab Sleman, Yogyakarta
          </button>
        </div>
      ...
      <!-- Col 2 -->
      <div class="bg-white mt-20 mb-20 px-10 rounded-3xl md:w-[55%] w-full">
        <h3 class="text-lg font-semibold pb-6 pt-10">Bisnis yang diinginkan<span class="text-red-500">*</span></h3>
        ...
        <form class="w-full pt-8 text-left">
          <div class="flex flex-col md:flex-row mb-6">
            <div class="w-full md:w-1/2 md:mx-2 mx-0 px-0 mb-6 md:mb-0">
              <label class="block tracking-wide text-black text-lg font-semibold pb-2" for="grid-name"
            ...
            <div class="w-full md:w-1/2 mx-0">
              <div class="w-full ml-0 md:ml-1">
                <label class="block tracking-wide text-black text-lg font-semibold pb-2" for="grid-number"
          ...
          <div class="flex flex-col md:flex-row mb-6">
            <div class="w-full md:w-1/2 px-0 md:mx-2 mx-0 mb-6 md:mb-0">
              <label class="block tracking-wide text-black text-lg font-semibold pb-2" for="grid-email"
          ...
          <div class="flex flex-col md:flex-row pb-6 mb-20">
            <div class="w-full md:mx-2 mx-0">
              <label class="block tracking-wide text-black text-lg font-semibold pb-2" for="grid-detail">
